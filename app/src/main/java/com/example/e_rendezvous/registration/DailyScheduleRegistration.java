...
public class DailyScheduleRegistration extends AppCompatActivity {

    private Button morningStartTimeButton, morningEndTimeButton, afternoonStartTimeButton, afternoonEndTimeButton, finishDailySchedule;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daily_schedule_registration);
            ...
            public void onClick(View v) {
                ...
                if(fullSchedule.isChecked()){
                    ...
                    if(!morningStartTimeButton.getText().equals("Έναρξη") && !morningEndTimeButton.getText().equals("Λήξη")
                        ...
                        updateSchedule();
                        ScheduleAdapter.getInstance().notifyItemChanged(dayPosition);
                        finish();
                    } else {
    ...
    private void timePopup(View v){
        TimePickerDialog newFragment = new TimePickerDialog(DailyScheduleRegistration.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth, new TimePickerDialog.OnTimeSetListener() {
