...
public class SimpleUserSelectDate extends AppCompatActivity implements OnNavigationButtonClickedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_simple_user_select_date);
        ...
        customCalendar.setOnDateSelectedListener(new OnDateSelectedListener() {
            ...
            public void onDateSelected(View view, Calendar selectedDate, Object desc) {
                ...
                if(!profUserWorkingDays.contains(selectedDate.get(Calendar.DAY_OF_WEEK))) {
                    ...
                    if(daySelected != "") {
                        Intent intent = new Intent(getApplicationContext(), SimpleUserFinalizeRendezvous.class);
